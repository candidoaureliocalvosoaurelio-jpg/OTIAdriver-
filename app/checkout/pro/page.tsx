  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-6 md:py-8">
      ...
      <section className="grid grid-cols-1 gap-5 md:grid-cols-[1.8fr_1.2fr]">
        <article className="rounded-2xl border border-emerald-300 bg-white shadow-xl ring-1 ring-emerald-200 overflow-hidden">
          <div className="p-6 md:p-7">
            <div className="flex items-center justify-between">
              <h2 className="text-xl md:text-2xl font-black">PRO</h2>
              <span className="rounded-full bg-emerald-600 text-white px-3 py-1 text-[10px] font-black tracking-wide shadow">
                RECOMENDADO
              </span>
            </div>
            ...
            <p className="mt-2 text-slate-700">Ideal para Profissionais Exigentes.</p>
            ...
            <div className="mt-5 rounded-xl bg-emerald-50 text-emerald-900/90 p-4 text-sm leading-relaxed">
        ...
        <aside className="rounded-2xl border border-emerald-200 bg-white shadow-2xl overflow-hidden">
          <div className="bg-teal-600 text-white p-6">
            <p className="text-xs opacity-95">Plano selecionado</p>
            <h3 className="text-2xl font-black mt-1">PRO</h3>
            <p className="mt-1 text-lg font-extrabold">R$ 49,90 <span className="text-white/90 text-sm font-semibold">/ mês</span></p>
          </div>
          ...
          <div className="p-6">
            ...
            <div className="mt-4 rounded-lg bg-emerald-50 p-3 text-xs text-emerald-900/90">
