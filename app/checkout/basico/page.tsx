...
function Check({ children }: { children: React.ReactNode }) {
  return (
    <li className="flex items-start gap-2 text-slate-900">
      <span className="mt-0.5 inline-flex h-5 w-5 items-center justify-center rounded-full bg-emerald-500 text-white text-xs font-black">
        ✓
      </span>
      <span>{children}</span>
    </li>
    ...
    <main className="mx-auto max-w-6xl px-4 py-6 md:py-8">
      ...
      <header className="text-center mb-6">
        ...
        <p className="text-slate-600 mt-1">
          Você selecionou o plano <strong>Básico</strong>.
        </p>
      </header>

      {/* grid principal */}
      <section className="grid grid-cols-1 gap-5 md:grid-cols-[1.8fr_1.2fr]">
        {/* cartão da esquerda (detalhes do plano) */}
        ...
        <aside className="rounded-2xl border border-slate-200 bg-white shadow-xl overflow-hidden">
          <div className="bg-[#0F2454] text-white p-6">
            ...
            <p className="mt-1 text-lg font-extrabold">
              R$ 29,90{" "}
              <span className="text-white/80 text-sm font-semibold">/ mês</span>
            </p>
          </div>
          ...
          <div className="p-6">
            ...
            <div className="mt-4 rounded-lg bg-slate-50 p-3 text-xs text-slate-600">
              ...
              <a href="mailto:otiadriver@gmail.com" className="underline">
