        ...
        <section className={s.grid}>
          <article className={s.card}>
            <div className={s.cardIn}>
              <h2 className={s.title}>Básico</h2>
          ...
          <aside className={s.card} style={{overflow:'hidden'}}>
            <div className={`${s.asideHeader} ${s.basicAside}`}>
              <p className="text-xs/none opacity-90">Plano selecionado</p>
              <h3 className="mt-1 text-2xl font-black">Básico</h3>
            ...
            <div className={s.asideBody}>
              <a
                ...
                aria-label="Pagar com Mercado Pago — Básico"
              >
