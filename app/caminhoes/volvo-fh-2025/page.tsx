...
<section className="mt-10 space-y-10">
  ...
  <div className="flex items-center gap-4 p-5 rounded-2xl border bg-red-50">
    {/* Ícone PDF (SVG simples, não precisa de arquivo de imagem) */}
    ...
    <div className="flex-1">
      ...
      <p className="text-xs text-slate-700 mb-1">
        Arquivo oficial em formato PDF, pronto para leitura, download ou impressão.
      </p>
  ...
  <div className="p-6 rounded-2xl border bg-slate-50">
    ...
    <p className="text-sm text-slate-700 mb-4">
      Clique no botão abaixo para abrir diretamente a ficha técnica oficial
      do Volvo FH 6x4T em uma nova aba.
    </p>
  ...
  <div className="p-5 rounded-2xl border bg-white md:flex md:items-center md:justify-between md:gap-4">
    <div className="mb-4 md:mb-0">
      ...
      <p className="text-xs text-slate-700 mt-1">
        Otimizada para acesso em dispositivos móveis: motoristas e técnicos
        podem abrir a ficha diretamente no celular ou tablet.
      </p>
    </div>
  ...
  <div className="p-6 rounded-2xl border shadow-sm bg-slate-900 text-slate-50">
    ...
    <p className="text-sm text-slate-200 mb-4">
      ...
      dimensionamento, especificação e comparativos de frota. Recomendado
      para gestores, engenheiros de aplicação e análise técnica.
    </p>
