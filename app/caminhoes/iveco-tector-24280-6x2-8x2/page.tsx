      ...
      <section className="max-w-6xl mx-auto px-4 mt-10 space-y-10">
        ...
        <section className="grid md:grid-cols-2 gap-8 items-start">
          <div>
            ...
            <p className="text-sm md:text-base text-slate-700 mb-3">
              ...
              suporte a operações de construção e mineração. :contentReference[oaicite:1]{index=1}
            </p>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-[1.3fr,1fr] gap-6 items-start">
            <div className="bg-white rounded-2xi border border-slate-200 shadow-sm p-5">
              <p className="text-sm text-slate-700 mb-3">
                ...
                operações com topografia acentuada. :contentReference[oaicite:2]{index=2}
              </p>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-3 gap-5 text-sm text-slate-800">
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4">
              ...
              <p>
                Disponível com uma das transmissões automatizadas mais elogiadas
                do segmento, com trocas até cerca de 60% mais rápidas em
                relação a caixas convencionais, reduzindo fadiga do motorista e
                otimizando o consumo. :contentReference[oaicite:3]{index=3}
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4">
              ...
              <p>
                Cabine reforçada, chassi mais robusto e suspensão dianteira com
                molas semielípticas suportam aplicações severas e uso vocacional
              ...
              <tbody>
                ...
                <tr className="border-b border-slate-200 bg-slate-50/60">
                  ...
                  <td className="px-4 py-3 text-slate-800">
                    ...
                    oferecendo trocas muito mais rápidas e menor fadiga do
                    motorista.
                  </td>
                </tr>
                <tr className="border-b border-slate-200">
                ...
                <tr className="border-b border-slate-200 bg-slate-50/60">
                  ...
                  <td className="px-4 py-3 text-slate-800">
                    Chassi reforçado, cabine com estrutura mais robusta e
                    suspensão dianteira com molas semielípticas, adequadas para
                    condições severas e uso vocacional.
                  </td>
                </tr>
                <tr className="border-b border-slate-200">
                  <th className="text-left px-4 py-3 font-semibold text-slate-700">
                  ...
                  <td className="px-4 py-3 text-slate-800">
                    ...
                    chuva, reduzindo o efeito de aquaplanagem.
                  </td>
                </tr>
                <tr>
                  <th className="text-left px-4 py-3 font-semibold text-slate-700">
