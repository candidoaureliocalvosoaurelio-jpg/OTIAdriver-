    ...
    <main className="min-h-screen w-full bg-slate-50 pb-16">
          ...
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-extrabold leading-tight text-slate-900 mb-4">
              ...
              <span className="block text-sky-600 text-xl md:text-2xl mt-1">
                Eficiência, conforto e disponibilidade máxima para o transporte
                rodoviário
              </span>
            </h1>
            ...
            <p className="text-sm md:text-base text-slate-700 mb-6 max-w-xl">
              ...
              extremamente confortável, motor <strong>PACCAR MX-13</strong>{" "}
              eficiente, transmissões automatizadas <strong>ZF TraXon</strong> e
              uma plataforma Euro 6 otimizada para entregar alta performance,
              baixo consumo e máxima disponibilidade operacional.
            </p>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link
                href="#ficha-tecnica"
                className="inline-flex items-center justify-center px-4 py-2.5 rounded-lg text-xs font-semibold bg-sky-600 text-white hover:bg-sky-700 transition"
              >
      ...
      <section className="max-w-6xl mx-auto px-4 mt-10 space-y-10">
        ...
        <section className="grid md:grid-cols-2 gap-8 items-start">
          <div>
            ...
            <p className="text-sm md:text-base text-slate-700 mb-3">
              ...
              em baixas rotações, transmissões automatizadas otimizadas, eixos
              traseiros de elevada eficiência e um{" "}
            ...
            <p className="text-sm md:text-base text-slate-700 mb-3">
              ...
              traz evoluções mecânicas e de software em relação à geração Euro
              5, elevando ainda mais a robustez, a confiabilidade e a
              eficiência. Essa combinação, somada ao{" "}
              <strong>Controle de Cruzeiro Preditivo</strong> (PCC), possibilita
              até <strong>8% de economia de combustível</strong> e redução de
              emissões de CO₂ em operações reais.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4">
              ...
              <ul className="text-sm text-slate-700 space-y-1.5">
                <li>
                  • Nova arquitetura Proconve P8 / Euro 6 altamente testada
                </li>
          ...
          <div className="grid md:grid-cols-3 gap-5 text-sm text-slate-800">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4">
              ...
              <p>
                ...
                que tornam o caminhão um verdadeiro local de trabalho e
                descanso.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-[1.3fr,1fr] gap-6 items-start">
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 text-sm text-slate-800">
              ...
              <ul className="space-y-1.5">
                <li>
                  • Linhas de cabine otimizadas para reduzir arrasto
                  aerodinâmico.
                </li>
                <li>
                  • Defletores, saias e detalhes de design que favorecem o fluxo
                  de ar.
                </li>
                <li>
                  • Conjunto frontal remodelado, com visual moderno e funcional.
                </li>
              </ul>
            </div>
          ...
          <div className="grid md:grid-cols-[1.3fr,1fr] gap-6 items-start">
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5">
              ...
              <ul className="text-sm text-slate-700 space-y-2">
                <li>
                  <strong>Família de motores:</strong> PACCAR MX-13 13L com novas
                  potências, incluindo versões de 480 e 530 cv.
                </li>
                <li>
                ...
                <li>
                  ...
                  frenagem de classe mundial, preservando os freios de serviço.
                </li>
              </ul>
            </div>
            ...
            <div className="bg-amber-50 border border-amber-100 rounded-2xl p-5 text-sm text-slate-800">
              ...
              <p className="mb-2">
                ...
                <strong>Modo Eco</strong> prioriza trocas de marchas em rotações
                mais baixas e estratégias que equilibram dirigibilidade com o
                menor consumo possível.
              </p>
              <p>
          ...
          <div className="grid md:grid-cols-3 gap-5 text-sm text-slate-800">
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4">
              ...
              <p>
                ...
                permite uso prolongado do EcoRoll.
              </p>
            </div>
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4">
              <p className="text-xs font-semibold text-amber-600 mb-1 uppercase">
              ...
              <p>
                ...
                tempo em que o veículo roda em embalo.
              </p>
            </div>
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4">
              <p className="text-xs font-semibold text-amber-600 mb-1 uppercase">
              ...
              <p>
                ...
                velocidade e trocas de marcha de forma inteligente.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-5 text-sm text-slate-800">
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5">
              ...
              <ul className="space-y-1.5">
                <li>• Chicotes elétricos e conexões redesenhados.</li>
                <li>
                  • Maior flexibilidade para instalação de acessórios auxiliares.
                </li>
                <li>• Menor probabilidade de falhas elétricas ao longo da vida útil.</li>
              </ul>
              <p className="mt-2">
                Resultado: <strong>disponibilidade máxima</strong> ao{" "}
                <strong>menor custo operacional</strong>.
              </p>
            </div>
            <div className="bg-slate-900 text-slate-50 rounded-2xl border border-slate-800 shadow-sm p-5">
              ...
              <ul className="space-y-1.5">
                <li>• Controle da embreagem protegido contra água e sujeira.</li>
                <li>• Alternador com controle eletrônico, otimizando as baterias.</li>
                <li>• Componentes projetados para maior durabilidade em uso intensivo.</li>
              </ul>
              <p className="mt-2">
                Essas inovações ajudam a reduzir{" "}
                <strong>custos de reparo e manutenção</strong>.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="configuracoes">
          ...
          <p className="text-sm md:text-base text-slate-700 mb-3">
            Além de novos motores e transmissões automatizadas, o DAF XF traz{" "}
            <strong>eixos traseiros de elevada eficiência</strong>, com relações
            mais rápidas (a partir de 2,64) para rotações mais baixas em cruzeiro.
          </p>
              ...
              <tbody>
                <tr className="border-b border-slate-200">
                  ...
                  <td className="px-4 py-3 text-slate-800">
                    Semirreboques leves/médios em rotas mais planas e cargas de menor PBTC.
                  </td>
                  <td className="px-4 py-3 text-slate-800">
                ...
                <tr>
                  ...
                  <td className="px-4 py-3 text-slate-800">
                    Altos PBTC, bitrens e rodotrens em rotas exigentes e com aclives acentuados.
                  </td>
                  <td className="px-4 py-3 text-slate-800">
                    Máxima tração e durabilidade do trem de força em composições pesadas.
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <p className="mt-3 text-sm text-slate-700">
            ...
            <strong>paradas não programadas</strong>, ampliar intervalos de serviço e
            entregar uma plataforma competitiva em <strong>TCO</strong>.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-5 text-sm text-slate-800">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5">
              ...
              <ul className="space-y-1.5">
                <li>• Cabine em aço de alta resistência.</li>
                <li>• Amplo para-brisa e retrovisores bem posicionados.</li>
                <li>• Itens que contribuem para maior proteção em operação.</li>
              </ul>
            </div>
          </div>
        </section>
