...
export default function PlanosPage() {
  return (
    <>
      {/* 🔧 Mata qualquer CSS legado desta rota (checks gigantes / opacidade baixa / cards antigos) */}
      <style jsx global>{`
        /* remove qualquer ::before em listas desta página */
        main[data-page="planos"] li::before { content: none !important; background: none !important; }
        /* garante 100% de opacidade em tudo dentro da seção de planos */
        main[data-page="planos"] * { opacity: 1 !important; filter: none !important; }
        /* neutraliza possíveis estilos antigos por classe genérica */
        .planos-grid, .plano-basico, .plano-pro, .plano-premium, .card { all: unset; }
      `}</style>

      <main data-page="planos" className="mx-auto max-w-6xl px-4 py-12 text-black">
        {/* Título e subtítulo */}
