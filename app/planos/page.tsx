      ...
      <section className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-3">
        ...
        <article className="flex min-h-[560px] flex-col overflow-hidden rounded-2xl bg-white shadow-xl ring-1 ring-black/5">
          ...
          <div className="bg-gradient-to-b from-slate-200 to-slate-100 px-6 py-7 text-center">
            <h3 className="text-3xl font-extrabold text-slate-900">Básico</h3>
          ...
          {/* corpo + botão alinhado ao rodapé */}
          <div className="flex grow flex-col px-6 py-6">
            ...
            <a
              ...
              className="mt-auto mb-4 inline-flex w-full items-center justify-center rounded-xl bg-[#0D2D60] px-4 py-3 text-base font-extrabold text-white shadow-lg hover:opacity-90 active:translate-y-[2px] transition"
            >
              Assinar Agora
            </a>
          </div>
        ...
        {/* PRO (RECOMENDADO) */}
        <article className="relative flex min-h-[600px] flex-col overflow-hidden rounded-2xl bg-white shadow-2xl ring-2 ring-emerald-300">
          {/* selo recomendado */}
          ...
          {/* cabeçalho */}
          <div className="px-6 py-7 text-center text-white" style={{ backgroundColor: "#1FB9AE" }}>
          ...
          <div className="flex grow flex-col px-6 py-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-auto mb-4 inline-flex w-full items-center justify-center rounded-xl bg-[#1DBF73] px-4 py-3 text-base font-extrabold text-white shadow-lg hover:opacity-90 active:translate-y-[2px] transition"
            >
              Assinar Agora
            </a>
          </div>
        ...
        <article className="flex min-h-[560px] flex-col overflow-hidden rounded-2xl bg-white shadow-xl ring-1 ring-black/5">
          {/* cabeçalho */}
          <div className="px-6 py-7 text-center text-white bg-[#0A2F75]">
          ...
          <div className="flex grow flex-col px-6 py-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-auto mb-4 inline-flex w-full items-center justify-center rounded-xl bg-[#0A2F75] px-4 py-3 text-base font-extrabold text-white shadow-lg hover:opacity-90 active:translate-y-[2px] transition"
            >
              Assinar Agora
            </a>
          </div>
