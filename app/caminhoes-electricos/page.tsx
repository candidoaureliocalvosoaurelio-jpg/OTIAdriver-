...
export const metadata = {
  ...
  description:
    "Galeria dos caminhões elétricos — inovação, eficiência e sustentabilidade com a OTIAdriver.",
};
    ...
    <main className="mx-auto max-w-6xl px-4 py-10">
      ...
      <div className="text-center mb-10">
        ...
        <p className="mt-3 text-gray-600 text-lg">
          Inovação e sustentabilidade sobre rodas — conheça os modelos elétricos mais
          avançados.
        </p>
      </div>
