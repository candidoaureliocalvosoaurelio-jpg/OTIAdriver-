        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          {icons.map((icon) => {
            ...
            return (
              ...
              {/* BLOCO FINAL – Cartão PDF (Luzes de aviso e símbolos) */}
<section className="mt-8">
  <div className="rounded-2xl border border-slate-200 bg-white p-5 md:p-6 shadow-sm">
    <h2 className="text-xl font-semibold text-slate-900 mb-2">
      Luzes de aviso e símbolos do painel (PDF)
    </h2>

    <p className="text-sm text-slate-700 mb-4">
      Material completo com a explicação detalhada das luzes de aviso,
      símbolos do painel e recomendações de ação para cada situação.
      Indicado para treinamentos, consultas rápidas e apoio ao motorista.
    </p>
    ...
    >
      Abrir material de luzes e símbolos (PDF)
    </a>
  </div>
</section>
</main>
