...
type Props = { params: { slug: "direcional" | "tracao" | "implemento" } };
    ...
    <main className="min-h-screen w-screen bg-gradient-to-b from-[#eef7ff] to-white py-10">
      <div className="mx-auto max-w-7xl px-4">
        ...
        <h1 className="text-2xl md:text-4xl font-extrabold text-[#0F2454] mt-4">
          {category.title} <span className="text-lg text-gray-500">• {category.subtitle}</span>
        </h1>
        ...
        <section className="mt-8">
          ...
          <p className="text-gray-600">
            Em breve: lista de pneus com ficha técnica, medidas, carga/pressão e aplicação.
          </p>
        </section>
