...
// app/(site)/freio-motor-como-usar/page.tsx
import Link from "next/link";


export const metadata = {
  title: "Freio Motor: como usar corretamente e economizar freio de serviço | OTIAdriver",
  description: "Veja como usar o freio motor do jeito certo em descidas para ganhar segurança e economizar lona e freio de serviço.",
};
  ...
  return (
    <main className="max-w-5xl mx-auto px-4 pt-6 pb-16">
      <nav className="text-sm text-slate-600 mb-4">
        ...
        <span className="text-slate-900 font-semibold">Freio Motor: como usar corretamente e economizar freio de serviço</span>
      </nav>
          ...
          <div className="flex flex-col md:flex-row gap-6 md:items-start md:justify-between">
            <div className="flex-1">
              <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight text-slate-900">
                Freio Motor: como usar corretamente e economizar freio de serviço
              </h1>

              <p className="mt-3 text-lg text-slate-700">
                Veja como usar o freio motor do jeito certo em descidas para ganhar segurança e economizar lona e freio de serviço.
              </p>
...
<article className="prose prose-slate max-w-none mt-10">
        ...
        <p>Freio motor usa compressão do motor para segurar o veículo, reduzindo uso do freio de serviço. Em descidas, ele é segurança e economia de lona.</p>

        <h2>⚠️ Principais causas</h2>
        <ul>
          <li>Marcha alta demais (não segura)</li>
          <li>Freio motor fraco para a descida</li>
          <li>Uso excessivo do freio de serviço (superaquecimento)</li>
        </ul>

        <h2>🧠 O que fazer na prática</h2>
        <ol>
          <li>Entre na descida já na marcha certa (antes de embalar).</li>
          <li>Use freio motor + (retarder se tiver) e o freio de serviço só para correções.</li>
          <li>Se embalar, reduza antes que fique crítico.</li>
        </ol>

        <h2>📌 Dica profissional</h2>
        <p>Se você usa freio de serviço o tempo todo na descida, você está gastando lona e aumentando o risco.</p>

        <h2>🔎 Perguntas frequentes</h2>
        <h3>Freio motor estraga o motor?</h3>
        <p>Não quando usado corretamente. Ele foi feito para isso.</p>

        <h3>Em pista molhada posso usar?</h3>
        <p>Pode, mas com suavidade e atenção para não perder aderência.</p>
        ...
        <div className="not-prose mt-4 flex flex-wrap gap-3">
          <Link href="/retarder-o-que-e" className="inline-flex items-center rounded-xl border border-slate-200 px-4 py-2 font-bold text-slate-900 hover:bg-slate-50 transition">
              Retarder: o que é
            </Link>
        </div>
