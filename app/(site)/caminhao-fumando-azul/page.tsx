...
// app/(site)/caminhao-fumando-azul/page.tsx
import Link from "next/link";


export const metadata = {
  title: "Caminhão Fumando Azul: o que significa e quanto pode custar | OTIAdriver",
  description: "Saiba o que significa fumaça azul no caminhão, principais causas e quando parar para evitar dano grave no motor.",
};
  ...
  return (
    <main className="max-w-5xl mx-auto px-4 pt-6 pb-16">
      <nav className="text-sm text-slate-600 mb-4">
        ...
        <span className="text-slate-900 font-semibold">Caminhão Fumando Azul: o que significa e quanto pode custar</span>
      </nav>
          ...
          <div className="flex flex-col md:flex-row gap-6 md:items-start md:justify-between">
            <div className="flex-1">
              <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight text-slate-900">
                Caminhão Fumando Azul: o que significa e quanto pode custar
              </h1>

              <p className="mt-3 text-lg text-slate-700">
                Saiba o que significa fumaça azul no caminhão, principais causas e quando parar para evitar dano grave no motor.
              </p>
...
<article className="prose prose-slate max-w-none mt-10">
        ...
        <p>Fumaça azul quase sempre indica queima de óleo. Pode ser turbina, anéis, retentores, respiro ou excesso de óleo.</p>

        <h2>⚠️ Principais causas</h2>
        <ul>
          <li>Turbo passando óleo</li>
          <li>Anéis/retentores do motor</li>
          <li>Respiro/cárter pressurizando</li>
          <li>Óleo acima do nível</li>
          <li>Ventilação do motor (respiro/PCV)</li>
        </ul>

        <h2>🧠 O que fazer na prática</h2>
        <ol>
          <li>Pare de forçar e monitore nível de óleo.</li>
          <li>Se o consumo de óleo aumentar rápido: pare.</li>
          <li>Faça diagnóstico (turbina é suspeita comum).</li>
        </ol>

        <h2>📌 Dica profissional</h2>
        <p>Fumaça azul + assobio diferente do turbo + consumo de óleo = cheque turbina urgente.</p>

        <h2>🔎 Perguntas frequentes</h2>
        <h3>Dá para rodar assim?</h3>
        <p>Pouco tempo e com risco. Se o óleo baixar, você destrói o motor.</p>

        <h3>Pode ser só óleo demais?</h3>
        <p>Sim. Nível acima do máximo pode causar queima e fumaça.</p>
