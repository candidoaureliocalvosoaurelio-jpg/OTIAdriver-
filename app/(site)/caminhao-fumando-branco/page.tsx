...
// app/(site)/caminhao-fumando-branco/page.tsx
import Link from "next/link";


export const metadata = {
  title: "Caminhão Fumando Branco: causas, riscos e solução | OTIAdriver",
  description: "Entenda as causas da fumaça branca no caminhão, quando é normal e quando pode indicar problema sério.",
};
  ...
  return (
    <main className="max-w-5xl mx-auto px-4 pt-6 pb-16">
      <nav className="text-sm text-slate-600 mb-4">
        ...
        <span className="text-slate-900 font-semibold">Caminhão Fumando Branco: causas, riscos e solução</span>
      </nav>
          ...
          <div className="flex flex-col md:flex-row gap-6 md:items-start md:justify-between">
            <div className="flex-1">
              <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight text-slate-900">
                Caminhão Fumando Branco: causas, riscos e solução
              </h1>

              <p className="mt-3 text-lg text-slate-700">
                Entenda as causas da fumaça branca no caminhão, quando é normal e quando pode indicar problema sério.
              </p>
...
<article className="prose prose-slate max-w-none mt-10">
        ...
        <p>Fumaça branca pode ser vapor/condensação (frio) ou sinal de água/combustão irregular. Se persistir quente, merece atenção.</p>

        <h2>⚠️ Principais causas</h2>
        <ul>
          <li>Condensação normal (frio)</li>
          <li>Diesel com água</li>
          <li>Problema em bico</li>
          <li>Junta/cabeçote (grave) se baixa água</li>
          <li>Estratégia/regeneração em alguns sistemas</li>
        </ul>

        <h2>🧠 O que fazer na prática</h2>
        <ol>
          <li>Veja se some com motor quente.</li>
          <li>Monitore nível do líquido de arrefecimento.</li>
          <li>Se tiver cheiro doce/baixar água/falhar: pare e diagnostique.</li>
        </ol>

        <h2>📌 Dica profissional</h2>
        <p>Fumaça branca persistente + baixa de água = sinal vermelho.</p>

        <h2>🔎 Perguntas frequentes</h2>
        <h3>Se for só de manhã é normal?</h3>
        <p>Pode ser condensação. Se some rápido, geralmente ok.</p>

        <h3>E se tiver cheiro forte?</h3>
        <p>Cheiro doce + fumaça branca pode indicar líquido de arrefecimento indo para a combustão.</p>
        ...
        <div className="not-prose mt-4 flex flex-wrap gap-3">
          <Link href="/modo-emergencia-caminhao" className="inline-flex items-center rounded-xl border border-slate-200 px-4 py-2 font-bold text-slate-900 hover:bg-slate-50 transition">
              Modo de emergência
            </Link>
        </div>
