  ...
  return (
    <main className="max-w-5xl mx-auto px-4 pt-6 pb-16">
      ...
      <nav className="text-sm text-slate-600 mb-4">
        ...
        <span className="text-slate-900 font-semibold">Título</span>
      </nav>
              ...
              <div className="mt-6 rounded-2xl border bg-slate-950 p-4 shadow-sm">
                <div className="flex items-center gap-3 mb-3">
                  <div className="h-10 w-10 rounded-xl bg-black/40 border border-white/10 flex items-center justify-center overflow-hidden">
                    <Image src="type" alt="Título" width={40} height={40} className="object-contain" />
                  </div>
              ...
              <div className="rounded-2xl bg-gradient-to-r from-[#1F6FEB] to-[#40E0D0] p-5 text-white shadow-lg">
                <div className="flex items-center gap-3">
                  <div className="h-12 w-12 rounded-2xl bg-white/15 flex items-center justify-center overflow-hidden">
                    <Image src="type" alt="Título" width={48} height={48} className="object-contain" />
                  </div>
                  <div>
...
<article className="prose prose-slate max-w-none mt-10">
        ...
        <p>Este guia explica o significado do alerta/situação, as causas mais comuns e o que fazer para evitar prejuízo. Se houver perda de potência, luz piscando ou ruído anormal, pare com segurança e faça diagnóstico.</p>

        <h2>⚠️ Principais causas</h2>
        <ul>
          <li>Manutenção atrasada (filtros, sensores, ajustes)</li>
          <li>Uso severo (subidas, carga alta, calor)</li>
          <li>Falha intermitente (conector, chicote, sensor)</li>
        </ul>

        <h2>🧠 O que fazer na prática</h2>
        <ol>
          <li>Reduza esforço do motor e monitore o painel.</li>
          <li>Evite acelerar forte e evite ‘puxar’ em subida.</li>
