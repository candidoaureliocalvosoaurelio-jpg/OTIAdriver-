...
// app/(site)/modo-emergencia-caminhao/page.tsx
import Link from "next/link";


export const metadata = {
  title: "Modo de Emergência no Caminhão: o que é e como sair com segurança | OTIAdriver",
  description: "Entenda por que o caminhão entra em modo de emergência, o que significa na prática e como agir com segurança.",
};
  ...
  return (
    <main className="max-w-5xl mx-auto px-4 pt-6 pb-16">
      <nav className="text-sm text-slate-600 mb-4">
        ...
        <span className="text-slate-900 font-semibold">Modo de Emergência no Caminhão: o que é e como sair com segurança</span>
      </nav>
          ...
          <div className="flex flex-col md:flex-row gap-6 md:items-start md:justify-between">
            <div className="flex-1">
              <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight text-slate-900">
                Modo de Emergência no Caminhão: o que é e como sair com segurança
              </h1>

              <p className="mt-3 text-lg text-slate-700">
                Entenda por que o caminhão entra em modo de emergência, o que significa na prática e como agir com segurança.
              </p>
            ...
            <div className="min-w-[260px] max-w-[360px] w-full">
              <div className="rounded-2xl bg-gradient-to-r from-[#1F6FEB] to-[#40E0D0] p-5 text-white shadow-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-extrabold text-lg">Guia do motorista</p>
                    <p className="text-white/90 text-sm">Conteúdo direto e prático</p>
                  </div>
                </div>
                ...
                <div className="mt-4 grid grid-cols-3 gap-2">
                  ...
                  <div className="rounded-xl bg-white/10 p-3">
                    ...
                    <p className="font-bold">Prático</p>
                  </div>
                  <div className="rounded-xl bg-white/10 p-3">
...
<article className="prose prose-slate max-w-none mt-10">
        ...
        <p>Modo de emergência é uma estratégia da ECU para proteger motor e emissões. O caminhão limita potência/torque quando detecta falha séria (sensores, pressão, temperatura, emissões).</p>

        <h2>⚠️ Principais causas</h2>
        <ul>
          <li>Falha em sensores críticos (MAP/MAF, temperatura, pressão)</li>
          <li>Pressão do turbo fora do padrão (vazamento/atuador)</li>
          <li>DPF saturado / falha na regeneração</li>
          <li>SCR/Arla com erro (pode limitar torque e até velocidade)</li>
          <li>Baixa pressão de combustível / filtro saturado</li>
          <li>Superaquecimento ou baixa pressão de óleo (grave)</li>
        </ul>

        <h2>🧠 O que fazer na prática</h2>
        <ol>
          <li>Tire o pé e procure local seguro.</li>
          <li>Evite subida/peso: reduza carga e rotação.</li>
          <li>Se a luz estiver piscando ou temperatura alta: PARE.</li>
          <li>Leia códigos com scanner e anote (foto ajuda).</li>
        </ol>

        <h2>📌 Dica profissional</h2>
        <p>Quando vem com limitação de velocidade, muitas vezes é emissões (DPF/SCR). Se vem com tremedeira/ruído, pode ser injeção/combustível.</p>

        <h2>🔎 Perguntas frequentes</h2>
        <h3>Modo de emergência estraga o caminhão?</h3>
        <p>Ele existe para proteger. O que estraga é ignorar a causa e continuar forçando.</p>

        <h3>Posso rodar até o destino?</h3>
        <p>Só se estiver leve e sem sinais graves. Se piorar, pare e evite prejuízo maior.</p>
        ...
        <div className="not-prose mt-4 flex flex-wrap gap-3">
          <Link href="/caminhao-perdendo-forca" className="inline-flex items-center rounded-xl border border-slate-200 px-4 py-2 font-bold text-slate-900 hover:bg-slate-50 transition">
              Caminhão perdendo força
            </Link>
            <Link href="/consumo-alto-diesel-caminhao" className="inline-flex items-center rounded-xl border border-slate-200 px-4 py-2 font-bold text-slate-900 hover:bg-slate-50 transition">
              Consumo alto de diesel
            </Link>
        </div>
