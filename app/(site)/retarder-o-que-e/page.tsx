...
// app/(site)/retarder-o-que-e/page.tsx
import Link from "next/link";


export const metadata = {
  title: "Retarder no Caminhão: o que é, como funciona e quando usar | OTIAdriver",
  description: "Entenda o que é o retarder, como funciona e como usar em descidas para segurar o caminhão com mais segurança.",
};
  ...
  return (
    <main className="max-w-5xl mx-auto px-4 pt-6 pb-16">
      <nav className="text-sm text-slate-600 mb-4">
        ...
        <span className="text-slate-900 font-semibold">Retarder no Caminhão: o que é, como funciona e quando usar</span>
      </nav>
          ...
          <div className="flex flex-col md:flex-row gap-6 md:items-start md:justify-between">
            <div className="flex-1">
              <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight text-slate-900">
                Retarder no Caminhão: o que é, como funciona e quando usar
              </h1>

              <p className="mt-3 text-lg text-slate-700">
                Entenda o que é o retarder, como funciona e como usar em descidas para segurar o caminhão com mais segurança.
              </p>
...
<article className="prose prose-slate max-w-none mt-10">
        ...
        <p>Retarder é um freio auxiliar (hidráulico ou eletromagnético) que ajuda a segurar em descidas sem gastar lona. Ele é um dos maiores aliados em serra.</p>

        <h2>⚠️ Principais causas</h2>
        <ul>
          <li>Uso incorreto em piso escorregadio</li>
          <li>Aquecimento por uso extremo</li>
          <li>Manutenção do conjunto conforme fabricante</li>
        </ul>

        <h2>🧠 O que fazer na prática</h2>
        <ol>
          <li>Use níveis progressivos, sem trancos.</li>
          <li>Combine com freio motor e escolha marcha adequada.</li>
          <li>Em baixa aderência, use com cuidado.</li>
        </ol>

        <h2>📌 Dica profissional</h2>
        <p>Retarder bem usado = freio de serviço mais frio, mais seguro e mais barato no fim do mês.</p>

        <h2>🔎 Perguntas frequentes</h2>
        <h3>Retarder substitui o freio?</h3>
        <p>Não. Ele reduz uso e aumenta segurança, mas o freio de serviço continua essencial.</p>

        <h3>Por que alguns caminhões não têm?</h3>
        <p>Depende do pacote/versão e aplicação do veículo.</p>
        ...
        <div className="not-prose mt-4 flex flex-wrap gap-3">
          <Link href="/freio-motor-como-usar" className="inline-flex items-center rounded-xl border border-slate-200 px-4 py-2 font-bold text-slate-900 hover:bg-slate-50 transition">
