// app/modulos/eficiencia-diesel/page.tsx
// Componente de renderização robusto do MDX para o Módulo 6
...
// Define o caminho para o arquivo .md do Módulo 6
const getContent = cache(async () => {
    // CORREÇÃO: Usa path.resolve para garantir o caminho absoluto no servidor
    const CONTENT_PATH = path.resolve(process.cwd(), 'content', 'modulos', 'eficiencia-diesel.md');
...
export default async function EficienciaDieselPage() {
