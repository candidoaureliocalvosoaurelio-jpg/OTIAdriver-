// app/modulos/conformidade-legal/page.tsx
// Componente de renderização robusto do MDX para o Módulo 4
...
// Define o caminho para o arquivo .md do Módulo 4
const getContent = cache(async () => {
    // CORREÇÃO: Usa path.resolve para garantir o caminho absoluto no servidor
    const CONTENT_PATH = path.resolve(process.cwd(), 'content', 'modulos', 'conformidade-legal.md');
    ...
    try {
        ...
        // Se o arquivo não for encontrado, exibe a página 404 (para evitar crash do build)
...
export default async function ConformidadeLegalPage() {
