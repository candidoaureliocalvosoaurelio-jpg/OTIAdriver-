(function () {
  const DICTS = {
    ...
    en: {
      ...
      hero_sub: "OTIAdriver powers your journey with technology and practical learning. Short content, voice & vision search, and an always-updated library.",
    ...
    zh: {
      ...
      hero_sub: "OTIAdriver 以技术与实用学习助力您的旅程。简短内容、语音与视觉搜索，以及持续更新的资料库。",
      cta_start: "立即开始",
      cta_talk: "联系团队",
      section_ai: "辅助 AI",
      section_ai_desc: "快速解答仪表符号与警报相关问题。",
      section_learn: "学习",
